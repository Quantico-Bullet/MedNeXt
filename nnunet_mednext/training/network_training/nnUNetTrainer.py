...
from nnunet_mednext.training.loss_functions.boundary_dou_loss import BoundaryDoU_CE_Loss, BoundaryDoU_Dice_Loss, BoundaryDoULoss, DoU_Dice_CE_Loss
...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        run = wandb.init(
            project="MedNeXt_SK5_Normal",
            name = f"MedNeXt_SSA_25_49_(ce=[1.0, 1.0, 0.7, 0.7])",
            config={                     
